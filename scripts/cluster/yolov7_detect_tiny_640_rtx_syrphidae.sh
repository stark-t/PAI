#!/bin/bash
#SBATCH --job-name=detect_yolov7_gpu_syrph # give a custom name
...
do
    ...
    do
        ...
        --save-conf \
        --nosave \
        --project runs/detect/job_"$SLURM_JOB_ID"_syrphidae_loop_detect_with_191623_yolov7_tiny_img640_b8_e300_hyp_custom \
...
# sbatch ~/PAI/scripts/cluster/yolov7_detect_tiny_640_rtx_syrphidae.sh