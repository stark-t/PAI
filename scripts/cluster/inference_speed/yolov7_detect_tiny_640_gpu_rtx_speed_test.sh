...
results_folder=runs/detect/detect_speed_jobs/job_"$SLURM_JOB_ID"_yolov7_tiny_gpurtx_results_at_"$conf"_iou_"$iou"
...
# sbatch ~/PAI/scripts/cluster/inference_speed/yolov7_detect_tiny_640_gpu_rtx_speed_test.sh