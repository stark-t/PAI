...
results_folder=runs/detect/detect_speed_jobs/job_"$SLURM_JOB_ID"_yolov5_small_cpu_results_at_"$conf"_iou_"$iou"
...
# sbatch ~/PAI/scripts/cluster/inference_speed/yolov5_detect_s_640_cpu_speed_test.sh