...
do
    ...
    do
        ...
        --save-conf \
        --nosave \
        --project runs/detect/job_"$SLURM_JOB_ID"_loop_detect_on_191623_yolov7_tiny_img640_b8_e300_hyp_custom \
...
# sbatch ~/PAI/scripts/cluster/yolov7_detect_tiny_640_rtx.sh