...
do
    ...
    do
        ...
        --save-conf \
        --nosave \
        --project runs/detect/job_"$SLURM_JOB_ID"_syrphidae_loop_detect_with_3219805_yolov7_img640_b8_e300_hyp_custom \
...
# sbatch ~/PAI/scripts/cluster/yolov7_detect_640_rtx_syrphidae.sh