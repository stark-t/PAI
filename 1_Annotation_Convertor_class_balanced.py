"""
Created on 29th of Nov. 2021
@author: Robin, Thomas

README:

- This Code will convert the annotation style of your dataset and put the images and labels into 2 seperate folders.
- Decide the Conversion, define the intention and the Input- and Output-folder (lines 29-43)
...
if not class_balance:
    output_PATH = r'C:\MASTERTHESIS\Data\P1_beta_dataset_2021_11_23_annotated_insect_detector'
else:
    output_PATH = r'C:\MASTERTHESIS\Data\P1_beta_dataset_2021_11_23_annotated_insect_detector_balanced'
